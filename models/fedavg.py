...
class FedAvGChd(FederatedModel):
    NAME = 'fedavgchd'
    COMPATIBILITY = ['homogeneity']

    def __init__(self, nets_list,args, transform):
        super(FedAvGChd, self).__init__(nets_list,args,transform)
    ...
    def loc_update(self,priloader_list):
        ...
        self.global_net = copy.deepcopy(self.nets_list[i])

        return  None

    def _train_net(self,index,net: nn.Module,train_loader):
